...
<style type="text/css">
	...
	.yun{ position:fixed;}
	.yun1{ z-index:-999; width:567px; height:185px; background:url(../../images/yun1.png) no-repeat center center; left:760px; top:118px;animation: myfirst6 50s linear infinite;-webkit-animation: myfirst6 50s linear infinite;}
	.yun2{ z-index:-999; width:605px; height:253px; background: url(../../images/yun2.png) no-repeat center center; left:100px; top:49px;animation: myfirst7 50s linear infinite;-webkit-animation: myfirst7 50s linear infinite;}
	.yun3{ z-index:-999; width:348px; height:226px; background: url(../../images/yun3.png) no-repeat center center; left:50px; top:300px;animation: myfirst8 50s linear infinite;-webkit-animation: myfirst8 50s linear infinite;}
	.yun4{ z-index:-999; width:786px; height:362px; background:url(../../images/yun4.png) no-repeat center center; left:562px; top:233px;animation: myfirst9 50s linear infinite;-webkit-animation: myfirst9 50s linear infinite;}
	@keyframes myfirst
	{
	from {bottom: -200px;}
	to {bottom: 800px;}
			...
			<div class="row" style="margin-top: 1%;" >
				...
				<div class="col-lg-5 col-xs-12"align="center"style="border-radius:10px;background-color: rgba(255,255,255,0.8);text-align: center;font-size: 200%;">
					<div class="row" style="margin-top: 4%;vertical-align: middle;align-items: center;">
						<img src="../../img/login14.png" style="width: 30px;height: 30px;"/>
