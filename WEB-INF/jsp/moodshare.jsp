	...
	<div class="container"style="margin-top:2%;">
			<div class="row" style="min-height: 600px;">
				...
				<div class="col-lg-8 col-xs-12" style="background-color: rgba(255,255,255,0.3);border-radius: 10px;">
					<div class="row">
						<div class="col-lg-4 col-xs-4" style="background-color:rgba(255,255,255,0);vertical-align: middle;margin-top: 2px;margin-left: 2px;height: 30px;">
					...
					<br />
					<div class="row" style="background-color:rgba(255,255,255,0.7);height: 145px;">
						<div class="clo-lg-12 col-xs-12" style="margin-left: 2%;">
							<div class="col-lg-12 col-xs-12" style="margin-bottom: 2%;margin-top: 2%;">
									<img src="../../img/person.png" style="width: 50px;height: 50px;border-radius:25px;background-color: red;"/>&nbsp;
						...
						<div class="clo-lg-12 col-xs-12" style="margin-left: 2%;">
							...
							<div class="col-lg-12 col-xs-12" style="color: #808080;">
								...
								<img src="../../img/background1.png" class="col-xs-12" style="max-width: 600px;max-height: 600px;"/>
							</div>
							<div class="col-lg-12 col-xs-12" style="margin-top: 2%;border-bottom: 1px solid #C5C5C5;">
								<div class="col-lg-3 col-xs-6"style="float: right;margin-bottom: 2%;">
									<img src="../../img/like3.png" style="width: 20px;height: 20px;" onclick="#"/>&nbsp;
						...
						<div class="clo-lg-12 col-xs-12" style="margin-left: 2%;">
							...
							<div class="col-lg-12 col-xs-12" style="color: #808080;">
								...
								<img src="../../img/author.png" class="col-xs-12" style="max-width: 600px;max-height: 600px;"/>
							</div>
							<div class="col-lg-12 col-xs-12" style="margin-top: 2%;border-bottom: 1px solid #C5C5C5;">
								<div class="col-lg-3 col-xs-6"style="float: right;margin-bottom: 2%;">
									<img src="../../img/like3.png" style="width: 20px;height: 20px;" onclick="#"/>&nbsp;
