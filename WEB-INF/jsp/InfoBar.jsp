<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page trimDirectivergba(255,255,255,0.7)spaces="true"%>
			...
			<div class="row" >
				<c:forEach items="${hotArticles }" var="hotArticle">
					<div class="col-lg-12" style="height:60px;overflow: hidden;rgba(255,255,255,0.7)-space: nowrap;text-overflow: ellipsis;background-color: rgba(255,255,255,0.7);border-bottom: 1px solid #C5C5C5;">
						...
						<span id="distri" style="font-size: small;max-width: 10em;overflow: hidden;rgba(255,255,255,0.7)-space: nowrap;text-overflow: ellipsis;">${hotArticle.content }</span></a>
					</div>
				</c:forEach>
			</div>
		</div>
