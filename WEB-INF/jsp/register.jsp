...
<script type="text/javascript" src="../../js/alertStyle.js" ></script>
<style type="text/css">
		html{
		height:100%;
		width:100%;
...
$(function(){
	...
	$("#userName").blur(function(){
		//1、失去焦点获得输入框的内容
		var usernameInput=$("#usernameConfirm").val();
		...
		$.post(
			...
			function(data){
				...
				if(!isExist){
					$("#usernameConfirm").attr("src","../../img/sign-error-icon.png");
			 		...
			 		if(usernameInput.length<2||usernameInput.length>6){
			 			...
			 			$("#usernameConfirm").attr("src","../../img/sign-check-icon.png");
			 		}
				}
			},
			"json"
	...
	$("#userPassword").blur(function(){
		...
		if(passwordInput.length<6||passwordInput.length>12){
			$("#passwordConfirm").attr("src","../../img/sign-error-icon.png");
		}
		else $("#passwordConfirm").attr("src","../../img/sign-check-icon.png");
	});
	...
	$("#email").blur(function(){
		...
		if(emailInput.length<1){
			$("#emailConfirm").attr("src","../../img/sign-error-icon.png");
		}
		else $("#emailConfirm").attr("src","../../img/sign-check-icon.png");
	})
	...
	$("#phone").blur(function(){
		...
		if(usercaptionInput.length!=11){
			$("#phoneConfirm").attr("src","../../img/sign-error-icon.png");
		}
		else $("#phoneConfirm").attr("src","../../img/sign-check-icon.png");
	});
	...
	$("#birthday").blur(function(){
		...
		if(birthdayInput.length<1){
			$("#birthdayConfirm").attr("src","../../img/sign-error-icon.png");
		}
		else $("#birthdayConfirm").attr("src","../../img/sign-check-icon.png");
	});
	...
	$("#passwordCheck").blur(function(){
		...
		if(confirmpwdInput==passwordInput){
			$("#passwordCheckConfirm").attr("src","../../img/sign-check-icon.png");
	 	}else{
	 		$("#passwordCheckConfirm").attr("src","../../img/sign-error-icon.png");
		}
	});
			...
			<div class="row" style="margin-top: 1%;" >
				...
				<div class="col-lg-10 col-xs-12"align="center"style="border-radius:10px;background-color: rgba(255,255,255,0.8);text-align: center;font-size: 200%;">
					<div class="row" style="margin-top: 2%;vertical-align: middle;align-items: center;">
						<img src="../../img/sign_up.png" style="width: 30px;height: 30px;"/>
								...
								<div class="row">
							 	...
							 	<div class="row">
									...
									<div class="col-lg-3 col-xs-2 my-col" style="text-align: left;">
								 		...
								 		<%-- <img src="../../img/sign-check-icon.png" style="width: 20px;height: 20px;margin-top: 10%;"" /> --%>
								 	</div>
							 	</div>
							 	<div class="row">
