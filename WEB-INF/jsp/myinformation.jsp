			...
			<div class="col-lg-3 col-xs-12"style="border-radius:10px;height: 800px;border-bottom: 1px solid #C5C5C5;background-color: rgba(255,255,255,0.7);" id="profilebar"></div>
				<div class="col-lg-8 hidden-xs" style="border-radius:10px;margin-left: 45px;background-color: rgba(255,255,255,0.7);" id="myariclebar">
					...
					<c:forEach items="${page.rows }" var="article">
						...
						<div class="row" style="background-color:height: 145px;border-bottom:1px solid #C5C5C5;">
							<div class="clo-lg-12" style="margin-top:2%;margin-left: 2%;">
								<h3 style="font-weight:bold;">
									${article.title }
								</h3>
								<div class="col-lg" style="height:40px ;width:80%;color: #808080;rgba(255,255,255,0.7)-space: nowrap;overflow: hidden;text-overflow: ellipsis;">
									${article.content}
								</div>
